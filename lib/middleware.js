  ...
  options.render = options.render || function(str, lessPath, cssPath, callback) {
    ...
    parser.parse(str, function(err, tree) {
        ...
        try {
          ...
          if ('object' === typeof options.sourceMap) {
            opts.sourceMap = true;
            opts.sourceMapFilename = options.sourceMap.sourceMapFilename;
            opts.sourceMapURL = options.sourceMap.sourceMapURL;
            opts.outputFilename = options.sourceMap.sourceMapOutputFilename;
            opts.sourceMapBasepath = options.sourceMap.sourceMapBasepath;
            opts.sourceMapRootpath = options.sourceMap.sourceMapRootpath;
          } else {
