 ...
 * @param  {Object} source      Object that will extend destination object
 * @return {Object}             Extended destination object
 */
var extend = function(destination, source){
  for (var property in source){
    if (destination[property] && (typeof(destination[property]) == 'object') && (destination[property].toString() == '[object Object]')) {
...
module.exports = less.middleware = function(options){
  ...
  // Less tree functions extends
  options.treeFunctions = options.treeFunctions || {};
  if(!!Object.keys(options.treeFunctions).length) {
