...
var imports = {},
    ...
    options, src, dest, root,
    parserOptions, toCSSOptions;
...
function render(str, lessPath, cssPath, callback) {
...
function parseOptions(config) {
  ...
  // `option.debug` handled in `log` function.

  // `option.prefix` handled in middleware callback.
