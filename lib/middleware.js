 ...
 *    `pre`             Function to transform input .less code before parsing,
...
module.exports = less.middleware = function(options){
  ...
  // Preprocessor
  options.pre = options.pre || function(src, req) { return src; };
    ...
    if (regex.handle.test(pathname)) {
      ...
      var compile = function() {
        ...
        fs.readFile(lessPath, 'utf8', function(err, str){
          ...
          try {
            options.render(options.pre(str, req), lessPath, cssPath, function(err, css){
              if (err) {
                lessError(err);
