...
module.exports = less.middleware = function(source, options){
  ...
  return function(req, res, next) {
    ...
    if (utilities.isValidPath(pathname)) {
      ...
      // Allow for preprocessing the parser path used for imports
      var importPaths = options.render.paths;
      options.render.paths = options.preprocess.importPaths(importPaths, req);
