...
**There is a beta version of 0.2.0 available. there will be several changes to the API so please test your code with the beta to discover any bugs before they become an issue. Also see the [Migration Guide](https://github.com/emberfeather/less.js-middleware/wiki/Migration-0.1.x-0.2.0) for what to expect and update.**
